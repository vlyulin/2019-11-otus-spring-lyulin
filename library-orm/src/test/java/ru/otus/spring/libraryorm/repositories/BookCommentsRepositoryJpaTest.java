...
@DataJpaTest
@Import({BookCommentsRepositoryJpa.class, UserRepositoryJpa.class, AppSession.class, Settings.class})
class BookCommentsRepositoryJpaTest {
    ...
    void getAllBookComments() throws BookNotFoundException {
        List<Comment> comments = bookCommentsRepositoryJpa.getAllBookComments(TOXIC_BOOK_ID);
    ...
    void addBookComment() throws BookNotFoundException {
        ...
        Comment comment = bookCommentsRepositoryJpa.addBookComment(TOXIC_BOOK_ID, NEW_COMMENT);
    ...
    void updateBookComment() {
        ...
        int cnt = bookCommentsRepositoryJpa.updateBookComment(TOXIC_BOOK_FIRST_COMMENT_ID, NEW_COMMENT);
    ...
    void deleteBookComment() {
        int cnt = bookCommentsRepositoryJpa.deleteBookComment(TOXIC_BOOK_FIRST_COMMENT_ID);
        assertThat(cnt).isEqualTo(EXPECTED_NUMBER_UPDATED_COMMENTS);
        Comment comment = em.find(Comment.class,TOXIC_BOOK_FIRST_COMMENT_ID);
