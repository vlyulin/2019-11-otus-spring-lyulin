...
import ru.otus.spring.libraryacl.models.*;
import ru.otus.spring.libraryacl.repositories.*;
import ru.otus.spring.libraryacl.services.UserService;
...
public class PagesController {
    ...
    public String newBook(Model model) {
        Book book = new Book();
        //TODO: Не получилось в thymeleaf проверить аттрибуты на null
        //Полное г., конечно
    ...
    public String editBook(@PathVariable(value="id") long bookId, Model model) {
        ...
        // TODO: обработка ошибки, если книга не найдена
        // if ( optBook.isEmpty() ) return "Страница обработки ошибки";
        List<LookupValue> lookupValues =
                lookupsRepository.findByLookupTypeLanguage(LookupValue.GENRES_LOOKUP_TYPE, LookupValue.RU);
