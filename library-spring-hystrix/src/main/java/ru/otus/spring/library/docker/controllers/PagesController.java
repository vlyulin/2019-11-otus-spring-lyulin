...
import ru.otus.spring.library.docker.config.hystrix.SecurityContextRegistratorCommandHook;
import ru.otus.spring.library.docker.feign.CalendarServiceProxy;
import ru.otus.spring.library.docker.models.*;
import ru.otus.spring.library.docker.repositories.*;
import ru.otus.spring.library.docker.services.BooksService;
...
public class PagesController {
    ...
    public PagesController(UserService userService,
                           ...
                           PublishingHousesRepository publishingHousesRepository, CalendarServiceProxy calendarServiceProxy) {
    ...
    public String indexPage(Model model) {
        // Пробуем феничку feign
        RussianCalendarDay day = calendarServiceProxy.currentDay();
