package ru.otus.spring.oca.repository;

import ru.otus.spring.oca.OracleCloudAppExtensionApp;

import ru.otus.spring.oca.config.Constants;
import ru.otus.spring.oca.config.audit.AuditEventConverter;
import ru.otus.spring.oca.domain.PersistentAuditEvent;
...
import static ru.otus.spring.oca.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
