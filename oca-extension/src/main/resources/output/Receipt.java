null	StandardReceiptId; //Standard Receipt ID
...
null	DocumentNumber; //Document Number
java.math.BigDecimal	Amount; //Receipt Amount
String	Currency; //Currency
String	ConversionRateType; //Conversion Rate Type
Date	ConversionDate; //Conversion Date
java.math.BigDecimal	ConversionRate; //Conversion Rate
String	State; //State
...
java.math.BigDecimal	UnappliedAmount; //Unapplied Amount
java.math.BigDecimal	AccountedAmount; //Accounted Amount
...
null	CreditCardAuthorizationRequestIdentifier; //Credit Card Authorization Request Identifier
